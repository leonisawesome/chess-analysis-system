#!/usr/bin/env python3
"""
Delete duplicate Alekhine book (keeping alekhine_2013, deleting alexander_1908).
"""
import hashlib
import subprocess
...
print(f"Keeping:  alekhine_2013_my_best_games_of_chess_russell_enterprises_inc.epub")
print()
