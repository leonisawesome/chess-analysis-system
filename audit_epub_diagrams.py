...
def main():
    ...
    sample_books = [
        "/Volumes/T7 Shield/rag/books/epub/kotronias_0000_the_safest_scandinavian_reloaded.epub",
        "/Volumes/T7 Shield/rag/books/epub/john_2012_play_the_french_everyman_chess.epub",
